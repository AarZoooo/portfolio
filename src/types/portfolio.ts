// Canonical portfolio data contract. The schema lives here (not in the
// feature) because chrome (Footer) and utils (groupByEmployer) consume
// these types too; universal modules must not depend on feature-private
// code. The feature's data.json is validated against this at build time.
import { z } from 'zod'
